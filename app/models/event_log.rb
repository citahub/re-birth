...
class EventLog < ApplicationRecord
  ...
  has_one :erc20_transfer, foreign_key: [:transaction_hash, :transaction_log_index], class_name: "Erc20Transfer", primary_key: [:transaction_hash, :transaction_log_index], inverse_of: :event_log
