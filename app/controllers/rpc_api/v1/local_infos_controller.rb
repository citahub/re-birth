    ...
    class LocalInfosController
      class << self
        ...
        def get_block_by_number(params)
          ...
          ActiveModelSerializers::SerializableResource.new(block, serializer: RpcApi::V1::BlockSerializer, flag: flag)
        end
        ...
        def get_transaction(params)
          ...
          ActiveModelSerializers::SerializableResource.new(transaction, serializer: RpcApi::V1::TransactionSerializer)
        end
        ...
        def get_meta_data(params)
          ...
          ActiveModelSerializers::SerializableResource.new(meta_data, serializer: RpcApi::V1::MetaDataSerializer)
        end
